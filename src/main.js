import { scaleFactor, dialogueData, mydialogueData } from "./constant";
import { k } from "./kaboomCtx";
import { displayDialogue, setCamScale } from "./utils";

k.loadSprite("spriteman", "./spritesheet.png", {
    sliceX: 39,
    sliceY: 31,
    // man:
    anims: {
...
k.loadSprite("spritefrog", "./spritesheet.png", {
    sliceX: 39,
    sliceY: 31,
    // frog:
    anims: {
...
k.scene("main", async () => {
    ...
    const player = k.make([
        k.sprite("spriteman", { anim: "idle-down" }),
...
k.scene("mymain", async () => {
    ...
    // create game object player
    const player = k.make([
        k.sprite("spritefrog", { anim: "idle-down" }),
        k.area({ // create hit box automatically for the game object
            shape: new k.Rect(k.vec2(0, 3), 10, 10), // create shape of rectangle that is 3 from center
        }),
        k.body(),
